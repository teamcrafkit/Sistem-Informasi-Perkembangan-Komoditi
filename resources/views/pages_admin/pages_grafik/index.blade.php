                    ...
                    <div class="col-lg-12">
                        <div class="p-2">
                            <form class="form-horizontal parsley-form" action="{{ $route }}" target="_blank"
                                ...
                                <div class="form-group row">
                                    <label for="jenis" class="col-md-2 col-form-label text-md-right">Jenis Komoditi</label>
                                    <div class="col-md-3">
                                        <select name="jenis" class="form-control required jenis" required>
                                            <option value="">Pilih--</option>
                                ...
                                <div class="form-group row field-tanggal">
