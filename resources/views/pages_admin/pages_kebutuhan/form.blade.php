                        ...
                        <form class="form-horizontal parsley-form" action="{{ $route }}" method="post" enctype="multipart/form-data" autocomplete="off"  data-parsley-validate novalidate autocomplete="off">
                            ...
                            @endif
                             <div class="form-group row">
                                <label class="col-form-label col-sm-2 text-sm-right" for="kebutuhan">Kebutuhan</label>
                                <div class="col-sm-4">
                                    <textarea type="text" id="kebutuhan" name="kebutuhan" placeholder="Kebutuhan"
                                        class="form-control required @error('kebutuhan') is-invalid @enderror" 
                                         required>{{ request()->segment(3) == 'edit' ? $data->kebutuhan : old('kebutuhan') }}</textarea>
                                    @error('kebutuhan')
