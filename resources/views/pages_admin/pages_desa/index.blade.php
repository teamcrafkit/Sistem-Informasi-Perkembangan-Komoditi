            ...
            <div class="card"> 
                <div class="card-body">
                    <h4 class="cars-title mb-3">
                        ...
                        <div class="btn-group pull-right"><a href="{{ $route }}" class="btn btn-primary btn-sm "style="text-transform:capitalize;">Tambah</a></div>
                    </h4>
                    <table id="dataTable" class="table table-bordered table-striped dt-responsive" style="width:100%">
                        <thead>
                            <tr>
                                <th width="1%" style="text-align: center;">No</th>
                                <th width="35%" style="text-align: center;" >Nama Kecamatan</th>
                                <th width="35%" style="text-align: center;" >Nama Desa</th>
