        ...
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-3">
                    ...
                    <div class="btn-group float-right"><button onClick="window.location.href='{{ $route }}'" class="btn btn-primary btn-sm" style="text-transform:capitalize;">Input</button></div>
                </h4> 
                <table class="table table-striped table-bordered dt-responsive nowrap dataTable">
                    <thead>
                        <tr>
                            ...
                            <th width="10%" style="text-align: center; ">Avatar</th>
