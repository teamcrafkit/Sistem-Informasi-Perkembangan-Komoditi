...
class JenisKomoditiController extends Controller
{
    protected $table        = JenisKomoditi::class;
    protected $path         = 'pages_admin.pages_jenis_komoditi';
    protected $routes       = 'data-jenis-komoditi';
    ...
    public function store(Request $request)
    {
        ...
        if ($check['status'] == TRUE) {
            ...
            return redirect()->route($this->routes . '.index')
                ->with([
                    'title' => 'Sukses!',
                    'data'  => "Data jenis komoditi dengan nama {$request->nama} berhasil di simpan",
                    'alert' => 'success',
                ]);
        } else {
            return back()->with([
                'title' => 'Error!',
                'data'  => "Data jenis komoditi dengan nama {$request->nama} ini sudah ada.",
                'alert' => 'error',
            ]);
        }
    }
     ...
     *
     * @param  \App\Models\JenisKomoditi  $jenisKomoditi
     * @return \Illuminate\Http\Response
     */
    public function show(JenisKomoditi $jenisKomoditi)
    {
        //
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($check['status'] == TRUE) {
            ...
            return redirect()->route($this->routes . '.index')
                ->with([
                    'title' => 'Sukses!',
                    'data'  => "Data jenis komoditi dengan nama {$request->nama} berhasil di update",
                    'alert' => 'success',
                ]);
        } else {
            return back()->with([
