...
{
    protected $table  = Role::class;
    protected $path   = 'pages_admin.pages_peran';
    protected $routes = 'peran';
    ...
    public function store(Request $request)
    {
        ...
        if ($check['status'] == TRUE) {
            ...
            return redirect()->route($this->routes . '.index')
                ->with([
                    'title' => 'Sukses!',
                    'data'  => 'Peran dengan nama ' . $request->name . ' berhasil di simpan',
                    'alert' => 'success',
                ]);
        } else {
            return back()->with([
                'title' => 'Error!',
                'data'  => 'Peran dengan nama ' . $request->name . ' yang anda isi sudah ada.',
                'alert' => 'error',
            ]);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($check['status'] == TRUE) {
            ...
            return redirect()->route($this->routes . '.index')
                ->with([
                    'title' => 'Sukses!',
                    'data'  => 'Peran dengan nama ' . $request->name . ' berhasil di update',
                    'alert' => 'success',
                ]);
        } else {
            return back()->with([
    ...
    public function destroy($id)
    {
        ...
        ->with([
            'title' => 'Sukses!',
            'data'  => 'Peran dengan nama ' . $data->name . ' berhasil di hapus',
            'alert' => 'success',
        ]);
    }
